...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.car_voter' => 'getApp_CarVoterService',
            ...
            'app.techs_voter' => 'getApp_TechsVoterService',
            'app.ticket_voter' => 'getApp_TicketVoterService',
            'app.user_voter' => 'getApp_UserVoterService',
    ...
    /**
     * Gets the 'app.car_voter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\CarVoter A AppBundle\Security\CarVoter instance
     */
    protected function getApp_CarVoterService()
    {
        return $this->services['app.car_voter'] = new \AppBundle\Security\CarVoter();
    }
    ...
    /**
     * Gets the 'app.techs_voter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\TechSheetVoter A AppBundle\Security\TechSheetVoter instance
     */
    protected function getApp_TechsVoterService()
    {
        return $this->services['app.techs_voter'] = new \AppBundle\Security\TechSheetVoter();
    }

    /**
     * Gets the 'app.ticket_voter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\TicketVoter A AppBundle\Security\TicketVoter instance
     */
    protected function getApp_TicketVoterService()
    {
        return $this->services['app.ticket_voter'] = new \AppBundle\Security\TicketVoter();
    }

    /**
     * Gets the 'app.user_voter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\UserVoter A AppBundle\Security\UserVoter instance
     */
    protected function getApp_UserVoterService()
    {
        return $this->services['app.user_voter'] = new \AppBundle\Security\UserVoter();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('oYWWSZ8nqS', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0Hk1wgkXbC', 0, 'NxMZDB2dw9zBXukLyzGjI-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'LesVoitures', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000003c008a95000000003a6d31955c2eb6b354e0f1472d8bca182ab11408(
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'E:\\PFAOrigin\\src\\AppBundle\\Entity')), 'AppBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_20d6112392363add0eb1a85a171282dc747fe0d4bcfe23b78419e2f6a60e675a');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'E:\\PFAOrigin\\app/Resources');
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.encoder.default'] = new \Lexik\Bundle\JWTAuthenticationBundle\Encoder\DefaultEncoder(new \Lexik\Bundle\JWTAuthenticationBundle\Services\JWSProvider\DefaultJWSProvider($this->get('lexik_jwt_authentication.key_loader'), 'openssl', 'RS256', 90000));
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader('E:\\PFAOrigin\\app/../var/jwt/private.pem', 'E:\\PFAOrigin\\app/../var/jwt/public.pem', 97123433);
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('htZ2dMEaZL', NULL, 'NxMZDB2dw9zBXukLyzGjI-', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\Utilisateur' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('E:\\PFAOrigin\\app/../var/sessions/dev');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf'), 'ar' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ar.xlf'), 'az' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.az.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.az.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.az.xlf'), 'bg' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.bg.xlf'), 'ca' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ca.xlf'), 'cs' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.cs.xlf'), 'cy' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf'), 'da' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.da.xlf'), 'de' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.de.xlf'), 'el' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.el.xlf'), 'en' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.en.xlf', 3 => 'E:\\PFAOrigin\\app/Resources/translations\\validators.en.yml'), 'es' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.es.xlf'), 'et' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf'), 'eu' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf'), 'fa' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fa.xlf'), 'fi' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf'), 'fr' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fr.xlf'), 'gl' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.gl.xlf'), 'he' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.he.xlf'), 'hr' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hr.xlf'), 'hu' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hu.xlf'), 'hy' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf'), 'id' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.id.xlf'), 'it' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.it.xlf'), 'ja' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ja.xlf'), 'lb' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lb.xlf'), 'lt' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lt.xlf'), 'lv' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lv.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lv.xlf'), 'mn' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf'), 'nl' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nl.xlf'), 'nn' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nn.xlf'), 'no' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.no.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.no.xlf'), 'pl' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pl.xlf'), 'pt' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf'), 'pt_BR' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_BR.xlf'), 'ro' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ro.xlf'), 'ru' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ru.xlf'), 'sk' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sk.xlf'), 'sl' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sl.xlf'), 'sq' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf'), 'sr_Cyrl' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Cyrl.xlf'), 'sr_Latn' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Latn.xlf'), 'sv' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sv.xlf'), 'th' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.th.xlf'), 'tr' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tr.xlf'), 'uk' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf'), 'vi' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.vi.xlf'), 'zh_CN' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 2 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.zh_CN.xlf'), 'zh_TW' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf'), 'pt_PT' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_PT.xlf'), 'ua' => array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ua.xlf'))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($b, 'E:\\PFAOrigin\\app', 'UTF-8'));
        ...
        $instance->addGlobal('img_dir', 'AppBundle/Images');
    ...
    {
        $this->services['twig.loader'] = $instance = new \Symfony\Bundle\TwigBundle\Loader\FilesystemLoader(${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}, $this->get('templating.name_parser'), 'E:\\PFAOrigin');

        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('E:\\PFAOrigin\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/views', 'Debug');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('E:\\PFAOrigin\\app/Resources/views');
        $instance->addPath('E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f8439eda6d966fd77be03ae788ade4018bd25458');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oJcEEFEKQV', 0, 'NxMZDB2dw9zBXukLyzGjI-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, $this->get('request_stack', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'E:\\PFAOrigin', '/_profiler/open?file=%f&line=%l#line%l');
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        ...
        $instance->setVoters(array(0 => $this->get('app.car_voter'), 1 => $this->get('app.techs_voter'), 2 => $this->get('app.ticket_voter'), 3 => $this->get('app.user_voter'), 4 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($a), 5 => new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter(new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage(), $b, $a), 6 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($b)));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ALLOWED_TO_SWITCH', 2 => 'ROLE_OWN')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle\\Entity\\Utilisateur', 'Username', NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'E:\\PFAOrigin\\app',
            ...
            'kernel.bundles_metadata' => array(
                'FrameworkBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ),
                'SecurityBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ),
                'TwigBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ),
                'MonologBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ),
                'SwiftmailerBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\swiftmailer-bundle',
                    'namespace' => 'Symfony\\Bundle\\SwiftmailerBundle',
                ),
                'DoctrineBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ),
                'SensioFrameworkExtraBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\sensio\\framework-extra-bundle',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ),
                'DoctrineMigrationsBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ),
                'AppBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\src\\AppBundle',
                    'namespace' => 'AppBundle',
                ),
                'LexikJWTAuthenticationBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\lexik\\jwt-authentication-bundle',
                    'namespace' => 'Lexik\\Bundle\\JWTAuthenticationBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ),
                'WebProfilerBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ),
                'SensioDistributionBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\sensio\\distribution-bundle',
                    'namespace' => 'Sensio\\Bundle\\DistributionBundle',
                ),
                'SensioGeneratorBundle' => array(
                    'parent' => NULL,
                    'path' => 'E:\\PFAOrigin\\vendor\\sensio\\generator-bundle',
            ...
            'secret' => 'f8439eda6d966fd77be03ae788ade4018bd25458',
            'jwt_key_pass_phrase' => 97123433,
            'locale' => 'en',
            'images_directory' => 'AppBundle/Images',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f8439eda6d966fd77be03ae788ade4018bd25458',
            ...
            'session.save_path' => 'E:\\PFAOrigin\\app/../var/sessions/dev',
            ...
            'router.resource' => 'E:\\PFAOrigin\\app/config/routing_dev.yml',
            ...
            'doctrine_migrations.dir_name' => 'E:\\PFAOrigin\\app/DoctrineMigrations',
            'doctrine_migrations.namespace' => 'Application\\Migrations',
            'doctrine_migrations.table_name' => 'migration_versions',
            'doctrine_migrations.name' => 'Application Migrations',
            'doctrine_migrations.organize_migrations' => false,
            'lexik_jwt_authentication.private_key_path' => 'E:\\PFAOrigin\\app/../var/jwt/private.pem',
            'lexik_jwt_authentication.public_key_path' => 'E:\\PFAOrigin\\app/../var/jwt/public.pem',
            'lexik_jwt_authentication.pass_phrase' => 97123433,
            'lexik_jwt_authentication.token_ttl' => 90000,
...
class DoctrineORMEntityManager_000000003c008a95000000003a6d31955c2eb6b354e0f1472d8bca182ab11408 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59103aaa73bc6815227719 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59103aaa73bd9211178137 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59103aaa73b99545136997 = array(
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getConnection', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getConnection();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getMetadataFactory', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getMetadataFactory();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getExpressionBuilder', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getExpressionBuilder();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'beginTransaction', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->beginTransaction();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getCache', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getCache();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'transactional', array('func' => $func), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->transactional($func);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'commit', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->commit();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'rollback', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->rollback();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getClassMetadata', array('className' => $className), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getClassMetadata($className);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'createQuery', array('dql' => $dql), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->createQuery($dql);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'createNamedQuery', array('name' => $name), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->createNamedQuery($name);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'createQueryBuilder', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->createQueryBuilder();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'flush', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->flush($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'clear', array('entityName' => $entityName), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->clear($entityName);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'close', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->close();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'persist', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->persist($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'remove', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->remove($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'refresh', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->refresh($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'detach', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->detach($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'merge', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->merge($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->copy($entity, $deep);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getRepository', array('entityName' => $entityName), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getRepository($entityName);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'contains', array('entity' => $entity), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->contains($entity);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getEventManager', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getEventManager();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getConfiguration', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getConfiguration();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'isOpen', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->isOpen();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getUnitOfWork', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getUnitOfWork();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getProxyFactory', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getProxyFactory();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'initializeObject', array('obj' => $obj), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->initializeObject($obj);
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'getFilters', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->getFilters();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'isFiltersStateClean', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->isFiltersStateClean();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'hasFilters', array(), $this->initializer59103aaa73bd9211178137);

        return $this->valueHolder59103aaa73bc6815227719->hasFilters();
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 = $initializer;
    }
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__get', array('name' => $name), $this->initializer59103aaa73bd9211178137);

        if (isset(self::$publicProperties59103aaa73b99545136997[$name])) {
            return $this->valueHolder59103aaa73bc6815227719->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59103aaa73bc6815227719;
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59103aaa73bd9211178137);
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__isset', array('name' => $name), $this->initializer59103aaa73bd9211178137);
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__unset', array('name' => $name), $this->initializer59103aaa73bd9211178137);
    ...
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__clone', array(), $this->initializer59103aaa73bd9211178137);

        $this->valueHolder59103aaa73bc6815227719 = clone $this->valueHolder59103aaa73bc6815227719;
    }

    public function __sleep()
    {
        $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, '__sleep', array(), $this->initializer59103aaa73bd9211178137);

        return array('valueHolder59103aaa73bc6815227719');
    }
    ...
    {
        return $this->initializer59103aaa73bd9211178137;
    }
    ...
    {
        return $this->initializer59103aaa73bd9211178137 && $this->initializer59103aaa73bd9211178137->__invoke($this->valueHolder59103aaa73bc6815227719, $this, 'initializeProxy', array(), $this->initializer59103aaa73bd9211178137);
    }
    ...
    {
        return null !== $this->valueHolder59103aaa73bc6815227719;
    }
    ...
    {
        return $this->valueHolder59103aaa73bc6815227719;
    }
